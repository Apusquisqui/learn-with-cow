...
Partial Class frm_Q2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "¿Cuál de las siguientes opciones NO" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " es un componente de entrada en un sistema i" &
    "nformático?"
        '
        'frm_Q2
        '
